...
const goalKeywords: Record<string, string[]> = {
  ...
  morning: ['warmup', 'mobility'],
  'wake up': ['warmup', 'mobility'],
  energy: ['warmup'],
  energize: ['warmup'],
  energetic: ['warmup'],
  alive: ['warmup'],
  groggy: ['warmup', 'mobility'],
  tired: ['warmup', 'recovery'],
  sluggish: ['warmup', 'mobility'],
  'get going': ['warmup'],
  jumpstart: ['warmup'],
...
const contextPhrases: Record<string, { goals: string[]; bodyRegions: string[] }> = {
  ...
  'just woke up': { goals: ['warmup', 'mobility'], bodyRegions: [] },
  'need energy': { goals: ['warmup'], bodyRegions: [] },
  'feel groggy': { goals: ['warmup', 'mobility'], bodyRegions: [] },
  'wake my body up': { goals: ['warmup', 'mobility'], bodyRegions: [] },
}
